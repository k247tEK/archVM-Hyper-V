...
update.. 2022-10 - `archlinux-2022.10.01-x86_64.iso`, removes `python2`.. breaking `gnome-system-tools` & `system-config-users`..<br>until one of these packages gets rebuild with `python3`..<br>ref: https://wiki.archlinux.org/title/users_and_groups
